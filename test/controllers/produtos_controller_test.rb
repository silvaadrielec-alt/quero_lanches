...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { estoque: @produto.estoque, nome: @produto.nome, valor_unitario: @produto.valor_unitario } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { estoque: @produto.estoque, nome: @produto.nome, valor_unitario: @produto.valor_unitario } }
